...
- 32 focused engine/tutorial tests: majorities, prerequisites, optional powers, money conversion, two-player blocking, illegal-move immutability, hidden information, dropped players, deterministic replay, legacy saves, the 4/5/6/1 footprint, floods and complete tutorials.
